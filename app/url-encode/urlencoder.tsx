...
const URLEncoder = () => {
  ...
  function onButtonClick(){
    setOutputValue(encodeURIComponent(inputValue as string).replaceAll('%20','+'));    
            ...
            <div className='bg-white p-3 mt-3 mb-5'>
              <label htmlFor="inputValue">Input Value</label>
                ...
                <div className='row justify-center'>
                    <button onClick={onButtonClick} className="btn btn-success mt-3 mb-3 col-4">Encode URL</button><br></br>
                </div>
            </div>
